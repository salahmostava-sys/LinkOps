...
export const ALL_COLUMNS = [
  { key: 'seq',                      label: 'م',                       labelKey: 'sequence',              sortable: false },
  { key: 'name',                     label: 'اسم الموظف',              labelKey: 'employeeName',          sortable: true  },
  { key: 'name_en',                  label: 'الاسم (إنجليزي)',         labelKey: 'nameEnglish',           sortable: true  },
  { key: 'national_id',              label: 'رقم الهوية',              labelKey: 'nationalId',             sortable: true  },
  { key: 'job_title',                label: 'المسمى الوظيفي',          labelKey: 'jobTitle',               sortable: true  },
  { key: 'city',                     label: 'المدن',                   labelKey: 'cities',                 sortable: true  },
  { key: 'phone',                    label: 'رقم الهاتف',              labelKey: 'phone',                  sortable: true  },
  { key: 'nationality',              label: 'الجنسية',                 labelKey: 'nationality',            sortable: true  },
  { key: 'platform_apps',            label: 'المنصة',                  labelKey: 'platform',               sortable: false },
  { key: 'commercial_record',        label: 'السجل التجاري',           labelKey: 'commercialRegistration', sortable: true  },
  { key: 'sponsorship_status',       label: 'حالة الكفالة',            labelKey: 'sponsorshipStatus',      sortable: true  },
  { key: 'status',                   label: 'حالة الموظف',             labelKey: 'employeeStatus',         sortable: true  },
  { key: 'join_date',                label: 'تاريخ الانضمام',          labelKey: 'joinDate',               sortable: true  },
  { key: 'birth_date',               label: 'تاريخ الميلاد',           labelKey: 'birthDate',              sortable: true  },
  { key: 'probation_end_date',       label: 'انتهاء فترة التجربة',     labelKey: 'probationEndDate',       sortable: true  },
  { key: 'residency_combined',       label: 'الإقامة',                 labelKey: 'residency',              sortable: true  },
  { key: 'health_insurance_expiry',  label: 'انتهاء التأمين الصحي',    labelKey: 'healthInsuranceExpiry',  sortable: true  },
  { key: 'license_status',           label: 'حالة الرخصة',             labelKey: 'licenseStatus',           sortable: true  },
  { key: 'license_expiry',           label: 'انتهاء الرخصة',           labelKey: 'licenseExpiry',           sortable: true  },
  { key: 'bank_account_number',      label: 'رقم الحساب البنكي',       labelKey: 'bankAccount',             sortable: false },
  { key: 'email',                    label: 'البريد الإلكتروني',       labelKey: 'email',                   sortable: false },
  { key: 'actions',                  label: 'الإجراءات',               labelKey: 'actions',                 sortable: false },
] as const;

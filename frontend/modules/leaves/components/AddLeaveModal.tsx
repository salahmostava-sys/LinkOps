...
export const AddLeaveModal = ({ open, onOpenChange, employees, onSaved }: Readonly<Props>) => {
    ...
    >
      ...
      <div className="bg-card border border-border rounded-2xl shadow-2xl w-full max-w-md mx-4 overflow-hidden relative z-10">
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            <label htmlFor="leave_type" className="block text-sm font-medium text-foreground mb-1">نوع الإجازة <span className="text-destructive">*</span></label>
            <select
              id="leave_type"
              className="w-full h-10 rounded-lg border border-border bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30"
              value={form.type}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="start_date" className="block text-sm font-medium text-foreground mb-1">من تاريخ <span className="text-destructive">*</span></label>
              <input
                id="start_date"
                type="date"
                className="w-full h-10 rounded-lg border border-border bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30"
            ...
            <div>
              <label htmlFor="end_date" className="block text-sm font-medium text-foreground mb-1">إلى تاريخ <span className="text-destructive">*</span></label>
              <input
                id="end_date"
                type="date"
                className="w-full h-10 rounded-lg border border-border bg-background px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30"
          ...
          <div>
            <label htmlFor="reason" className="block text-sm font-medium text-foreground mb-1">السبب (اختياري)</label>
            <textarea
              id="reason"

...
COMMENT ON COLUMN public.employees.commercial_record IS 'Ø±Ù‚Ù… Ø§Ù„Ø³Ø¬Ù„ Ø§Ù„ØªØ¬Ø§Ø±ÙŠ Ù„Ù„Ù…Ù†Ø¯ÙˆØ¨ - ÙŠØ³ØªØ®Ø¯Ù… ÙÙŠ Ø§Ù„ØªÙ†Ø¨ÙŠÙ‡Ø§Øª ÙˆØ§Ù„ØªÙ‚Ø§Ø±ÙŠØ±';

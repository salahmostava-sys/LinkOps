...
CREATE POLICY "unified_delete_policy" ON public."edge_rate_limits" FOR DELETE
  USING (((auth.role() = 'authenticated'::text) OR (is_active_user((select auth.uid())) AND (has_role((select auth.uid()), 'admin'::app_role) OR has_role((select auth.uid()), 'operations'::app_role)))));
...
CREATE POLICY "unified_insert_policy" ON public."edge_rate_limits" FOR INSERT
  WITH CHECK (((auth.role() = 'authenticated'::text) OR (is_active_user((select auth.uid())) AND (has_role((select auth.uid()), 'admin'::app_role) OR has_role((select auth.uid()), 'operations'::app_role)))));
...
CREATE POLICY "unified_delete_policy" ON public."finance_transactions" FOR DELETE
  USING (((auth.role() = 'authenticated'::text) OR (is_active_user((select auth.uid())) AND (has_role((select auth.uid()), 'admin'::app_role) OR has_role((select auth.uid()), 'finance'::app_role)))));
...
CREATE POLICY "unified_insert_policy" ON public."finance_transactions" FOR INSERT
  WITH CHECK (((auth.role() = 'authenticated'::text) OR (is_active_user((select auth.uid())) AND (has_role((select auth.uid()), 'admin'::app_role) OR has_role((select auth.uid()), 'finance'::app_role)))));

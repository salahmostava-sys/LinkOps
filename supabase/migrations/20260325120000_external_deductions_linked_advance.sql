-- Ø±Ø¨Ø· Ø®ØµÙ… Ø®Ø§Ø±Ø¬ÙŠ (Ù…Ø®Ø§Ù„ÙØ©) Ø¨Ø³Ù„ÙØ© Ø¹Ù†Ø¯ Ø§Ù„ØªØ­ÙˆÙŠÙ„ â€” Ø¨Ø¯Ù„ Ø§Ù„Ø§Ø¹ØªÙ…Ø§Ø¯ Ø¹Ù„Ù‰ Ù†Øµ Ø§Ù„Ù…Ù„Ø§Ø­Ø¸Ø© ÙÙ‚Ø·
...
COMMENT ON COLUMN public.external_deductions.linked_advance_id IS 'Ø¹Ù†Ø¯ ØªØ­ÙˆÙŠÙ„ Ø§Ù„Ù…Ø®Ø§Ù„ÙØ© Ù„Ø³Ù„ÙØ©: Ù…Ø¹Ø±Ù‘Ù Ø§Ù„Ø³Ù„ÙØ© Ø§Ù„Ù…Ù†Ø´Ø£Ø©';

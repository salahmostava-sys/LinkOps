-- Revert views to their original definitions from 20260410000000_performance_engine_foundation.sql
...
-- Revert performance_dashboard_rpc to its definition from 20260706000000_fix_performance_dashboard_rpc_shape.sql
